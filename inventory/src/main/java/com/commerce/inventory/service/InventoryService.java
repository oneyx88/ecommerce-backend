...
public interface InventoryService {
    ...
    List<InventoryResponse> getSellerInventories(String sellerId);

    InventoryResponse createSellerInventory(String sellerId, Long productId, InventoryRequest request);
}
