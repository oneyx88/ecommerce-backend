...
import com.commerce.payment.service.StripeService;
...
public class PaymentController {
    ...
    @PostMapping("/stripe/pay/orders/{orderId}")
    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<String> createStripePaymentIntent(@PathVariable Long orderId) throws StripeException {
        String clientSecret = stripeService.createStripePaymentIntent(orderId);
